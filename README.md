...
- [04｜农业机器人作物行视觉感知](projects/04_crop_row_perception/)：Day59合同已原位修订为多作物行、左右边界和行间走廊中心任务；Day60完成多行标签实审，Day61/62冻结全幅颜色与形态学输入，Day63完成多行重学。Day64也已原位重学为多行边界、走廊中心、行间距和多线图像消失点测量，核心测量门通过；下一步进入Day65多行时序与安全拒识，false-valid、物理标定和外部泛化仍为 `BLOCKED`。
