...
- [04｜农业机器人作物行视觉感知](projects/04_crop_row_perception/)：Day59 完成目标契约，Day60 完成数据实审与受限正样本门禁恢复，Day61 冻结有界 Gray-World+HSV，Day62 冻结方向性形态学与透视感知区域过滤，Day63 冻结多尺度掩膜特征与Extra Trees端点回归，Day64 完成图像偏移、方向、消失点和标定边界；可继续 Day65 视频时序稳定，但完整拒识与外部泛化门禁仍为 `BLOCKED`。
